...
class AccountTransactionsDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\App\AccountTransactionsDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('accounttransactionsdatatable-table')
    ...
    {
        return 'AccountTransactions_' . date('YmdHis');
    }
}
